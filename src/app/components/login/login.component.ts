      ...
      <div class="login-container">
        <div class="login-box">
          ...
          <div *ngIf="testStartTime && testEndTime" class="test-time-info">
            <div class="time-badge" [class.active]="isTestActive" [class.upcoming]="isTestUpcoming" [class.expired]="isTestExpired">
            ...
            <div class="time-details">
              <div class="time-item">
                ...
                <span class="time-value">{{formatDateTime(testStartTime)}}</span>
              </div>
              <div class="time-item">
                <span class="time-label">End:</span>
                <span class="time-value">{{formatDateTime(testEndTime)}}</span>
              </div>
            </div>
          </div>
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="login-form">
            ...
            <button type="button" (click)="startTest()" [disabled]="!loginForm.valid || !isTestActive" class="start-test-btn">
              <span class="button-icon">🎯</span>
              <span class="button-text">Start Test</span>
            </button>
            
            <div *ngIf="!isTestActive && (isTestUpcoming || isTestExpired)" class="test-availability-message">
              <p *ngIf="isTestUpcoming">This test will be available starting {{formatDateTime(testStartTime)}}</p>
              <p *ngIf="isTestExpired">This test expired on {{formatDateTime(testEndTime)}}</p>
            </div>
    ...
    if (this.loginForm.valid) {
      ...
      if (!this.isTestActive) {
        if (this.isTestUpcoming) {
          alert(`This test is not yet available. It will start on ${this.formatDateTime(this.testStartTime)}.`);
        } else if (this.isTestExpired) {
          alert(`This test has expired. It ended on ${this.formatDateTime(this.testEndTime)}.`);
        }
        return;
      }
