                ...
                <div class="instructions-section">
                  <div class="instructions-card">
                    ...
                    <div class="instructions-content">
                      <p class="instructions-intro">Please read the following instructions carefully before starting the test:</p>
                      
                      <div class="instruction-group">
                        <h3>General Guidelines</h3>
                        <ul>
                          <li>You have a total of <strong>2 hours</strong> to complete all sections of the test.</li>
                          <li>Do not refresh or close the browser window during the test.</li>
                          <li>Ensure you have a stable internet connection throughout the test duration.</li>
                        ...
                        <div class="section-info">
                          <div class="section-info-item">
                            ...
                            <div class="section-info-details">
                              ...
                              <p>Select the correct option for each question. All questions carry equal marks.</p>
                            </div>
                          </div>
                          ...
                          <div class="section-info-item">
                            ...
                            <div class="section-info-details">
                              ...
                              <p>Write code to solve the given problems. Your code will be evaluated for correctness and efficiency.</p>
                            </div>
                          </div>
                      ...
                      <div class="instruction-group">
                        <h3>Submission</h3>
                        <ul>
                          <li>You can navigate between sections at any time using the navigation panel.</li>
                          <li>Once you've completed all sections, click the "Submit Test" button at the top right.</li>
                          <li>After submission, you won't be able to make any changes to your answers.</li>
                        </ul>
                      </div>
                      
                      <div class="start-button-container">
                        <button class="start-test-btn" (click)="currentSection = 'mcq'">
                          Start Test
                        </button>
                      </div>
                    </div>
        ...
        <div class="modal-overlay">
          <div class="modal-container">
            ...
            <div class="modal-body">
              ...
              <p class="modal-warning">Once submitted, you won't be able to make any changes.</p>
            ...
            <div class="modal-footer">
              <button class="modal-cancel-btn" (click)="showSubmitConfirmation = false">
                Cancel
              </button>
