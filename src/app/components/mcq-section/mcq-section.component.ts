      ...
      <div class="mcq-content">
        @if (loading) {
          ...
          @for (question of questions; track question.id; let qIndex = $index) {
            <div class="question-card" [class.answered]="selectedAnswers[question.id] !== undefined">
              ...
              <div class="options">
                @for (option of question.options; track option.id; let i = $index) {
                  <div class="option" [class.selected]="selectedAnswers[question.id] === option.id">
                    <input 
                      type="radio" 
                    ...
                    <label [for]="'q' + question.id + 'o' + option.id">
                      <span class="option-marker">{{ ['A', 'B', 'C', 'D', 'E', 'F'][i] }}</span>
