        ...
        <div class="p-6 h-[calc(100%-200px)] overflow-y-auto">
          ...
          <div *ngIf="currentStep === 0">
            <div class="space-y-6">
              <!-- Role Selection -->
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Select Job Role</label>
                <div class="relative">
              ...
              <!-- Popular Roles -->
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Popular Roles</label>
                <div class="flex flex-wrap gap-2">
                  <button *ngFor="let role of popularRoles"
          ...
          <div *ngIf="currentStep === 1">
            <div class="space-y-6">
              <!-- Selection Method -->
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-4">How would you like to add questions?</label>
                <div class="space-y-3">
                  <label class="flex items-center p-4 border rounded-lg cursor-pointer"
                    ...
                    >
                    <span class="ml-3">
                      <span class="block font-medium text-gray-800">Automatically</span>
                      <span class="text-sm text-gray-500">AI-powered question selection based on skills</span>
                    </span>
                  </label>
                  ...
                  <label class="flex items-center p-4 border rounded-lg cursor-pointer"
                    ...
                    <span class="ml-3">
                      ...
                      <span class="text-sm text-gray-500">Select questions yourself</span>
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div>
                <div class="flex justify-between items-center mb-4">
                  <label class="block text-sm font-medium text-gray-700">Recommended Skills</label>
                  <button class="text-blue-600 text-sm hover:text-blue-800 flex items-center gap-1">
                    <span class="material-icons text-base">upload_file</span>
                    Import from JD
                  </button>
                </div>
                <div class="flex flex-wrap gap-2">
                  <button *ngFor="let skill of recommendedSkills"
          ...
          <div *ngIf="currentStep === 2">
            <div class="space-y-6">
              ...
              <!-- Experience Level -->
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-4">Experience Level</label>
                <div class="grid grid-cols-2 gap-3">
                  <button *ngFor="let level of experienceLevels"
                          (click)="selectExperience(level)"
                          class="p-4 border rounded-lg text-left transition-colors"
                          [class.border-blue-500]="assessment.experienceLevel === level"
                          [class.bg-blue-50]="assessment.experienceLevel === level">
                    <span class="block font-medium text-gray-800">{{level}}</span>
                    <span class="text-sm text-gray-500">{{getExperienceDescription(level)}}</span>
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2 mb-2">
                  <span *ngFor="let tag of assessment.tags; let i = index" 
          ...
          <div *ngIf="currentStep === 3">
            <div class="space-y-6">
              <div *ngFor="let section of reviewSections" class="bg-gray-50 rounded-lg p-4">
                ...
                <div [ngSwitch]="section.type">
                  ...
                  <!-- Settings Display -->
                  <div *ngSwitchCase="'settings'" class="space-y-2 text-gray-700">
                    <div>Experience: {{assessment.experienceLevel}}</div>
                    <div>Duration: {{assessment.duration}} minutes</div>
                    <div class="flex flex-wrap gap-2">
                      <span *ngFor="let tag of assessment.tags"
...
export class CreateAssessmentModalComponent {
  ...
  getStepSubtitle(): string {
    switch (this.currentStep) {
      case 0: return 'Select job role';
      case 1: return 'How would you like to add questions?';
      case 2: return 'Set experience level & duration';
      case 3: return 'Review your test';
      default: return '';
    }
  }
  ...
  getExperienceDescription(level: string): string {
    switch (level) {
      case '0 - 4 years': return 'Entry to Mid Level';
      case '5 - 8 years': return 'Senior Level';
      case '9 - 12 years': return 'Lead Level';
      case '13 - 16 years': return 'Principal Level';
      default: return '';
    }
  }
