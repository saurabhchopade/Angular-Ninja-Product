...
import { FullStackQuestion, Framework, ProjectSetup } from '../../types/fullstack-question.type';
    ...
    >
      ...
      >
        ...
        <div class="flex justify-between items-center p-4 border-b">
          <h2 class="text-xl font-semibold text-gray-800">Create Full Stack Question</h2>
          <button 
            (click)="close()" 
        ...
        <div class="p-6 h-[calc(100%-200px)] overflow-y-auto">
          ...
          <div *ngIf="currentStep === 1">
            <div class="space-y-8">
              <!-- Frontend Frameworks -->
              <div>
                <h3 class="text-lg font-medium text-gray-800 mb-4">Frontend Framework</h3>
                <div class="grid grid-cols-3 gap-3">
                  <button *ngFor="let framework of availableFrontendFrameworks"
                    ...
                    <div class="text-sm text-gray-500">v{{framework.version}}</div>
                  </button>
              ...
              <!-- Backend Frameworks -->
              <div>
                <h3 class="text-lg font-medium text-gray-800 mb-4">Backend Framework</h3>
                <div class="grid grid-cols-3 gap-3">
                  <button *ngFor="let framework of availableBackendFrameworks"
            ...
            <div class="space-y-6">
              <div class="grid grid-cols-3 gap-4">
                ...
                <button 
                  ...
                  [class.border-green-500]="question.projectSetup.type === 'zip'"
                  [class.bg-green-50]="question.projectSetup.type === 'zip'">
                  <span class="material-icons text-4xl mb-2 text-gray-600">folder_zip</span>
                  <div class="font-medium">Upload ZIP</div>
                  <p class="text-sm text-gray-500 mt-1">Upload your project files</p>
                </button>
                ...
                <button 
                  ...
                  class="p-6 border rounded-lg hover:border-green-500 hover:bg-green-50 transition-all text-center"
                  [class.border-green-500]="question.projectSetup.type === 'github'"
                  [class.bg-green-50]="question.projectSetup.type === 'github'">
                  <span class="material-icons text-4xl mb-2 text-gray-600">code</span>
                ...
                <button 
                  ...
                  class="p-6 border rounded-lg hover:border-green-500 hover:bg-green-50 transition-all text-center"
                  [class.border-green-500]="question.projectSetup.type === 'sample'"
                  [class.bg-green-50]="question.projectSetup.type === 'sample'">
                  <span class="material-icons text-4xl mb-2 text-gray-600">description</span>
              ...
              <!-- ZIP File Upload -->
              <div *ngIf="question.projectSetup.type === 'zip'" class="border-2 border-dashed rounded-lg p-8 text-center">
                <span class="material-icons text-4xl text-gray-400 mb-2">upload_file</span>
                <p class="text-gray-600">Drag and drop your project ZIP file here, or click to browse</p>
                <input type="file" class="hidden" accept=".zip">
              </div>

              <!-- Sample Project Selection -->
              <div *ngIf="question.projectSetup.type === 'sample'" class="space-y-4">
                <h3 class="text-lg font-medium text-gray-800">Choose a Sample Project</h3>
                <div class="grid grid-cols-2 gap-4">
                  <button *ngFor="let sample of sampleProjects"
                          class="p-4 border rounded-lg hover:border-green-500 hover:bg-green-50 transition-all text-left">
                    <div class="font-medium">{{sample.name}}</div>
                    <p class="text-sm text-gray-500 mt-1">{{sample.description}}</p>
                  </button>
                </div>
              </div>
            </div>
...
export class CreateFullStackModalComponent {
  ...
  sampleProjects = [
    { name: 'E-commerce Platform', description: 'A basic e-commerce setup with product listing and cart functionality' },
    { name: 'Task Management', description: 'Project management tool with task creation and assignment' },
    { name: 'Blog Platform', description: 'Simple blogging platform with posts and comments' },
    { name: 'Chat Application', description: 'Real-time chat application with websocket integration' }
  ];
  ...
  get canProceed(): boolean {
    switch (this.currentStep) {
      ...
      case 1:
        return this.question.projectSetup.frontendFramework !== null && 
  ...
  get isComplete(): boolean {
    return this.question.title.trim() !== '' && 
           ...
           this.question.projectSetup.backendFramework !== null &&
           ((this.question.projectSetup.type === 'github' && this.question.projectSetup.url?.trim() !== '') ||
