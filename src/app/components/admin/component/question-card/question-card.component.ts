...
export class QuestionCardComponent {
  ...
  getDifficultyClass(): string {
    ...
    switch (this.question.difficultyLevel) {
      case "Basic":
        return baseClasses + "bg-green-50 text-green-600 border-green-100";
      case "Intermediate":
        return baseClasses + "bg-yellow-50 text-yellow-600 border-yellow-100";
      case "Advanced":
        return baseClasses + "bg-red-50 text-red-600 border-red-100";
      default:
        return baseClasses + "bg-gray-50 text-gray-600 border-gray-100";
    }
  }
}
